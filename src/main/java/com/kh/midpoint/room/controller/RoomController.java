...
public class RoomController {
	...
	@GetMapping("/{roomId}")
	public ApiResponse<RoomResponse> get(@PathVariable("roomId") String roomId) {
		return ApiResponse.ok(roomService.getRoom(roomId));
	}

	@PostMapping("/{roomId}/participants")
	public ResponseEntity<ApiResponse<Map<String, String>>> join(@PathVariable("roomId") String roomId, @RequestBody JoinRoomRequest request) {
	...
	public ResponseEntity<Void> leave(@PathVariable("roomId") String roomId, @PathVariable("participantId") Long participantId) {
	...
	public ResponseEntity<ApiResponse<Void>> updateLocation(
			@PathVariable("roomId") String roomId, @PathVariable("participantId") Long participantId, @RequestBody UpdateLocationRequest request
	) {
	...
	public ResponseEntity<ApiResponse<Void>> setMode(@PathVariable("roomId") String roomId, @RequestBody SetModeRequest request) {
		roomService.setMode(roomId, request.getMode());
		return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.updated());
	}

	@PostMapping("/{roomId}/midpoint")
	public ResponseEntity<ApiResponse<Void>> findMidpoint(@PathVariable("roomId") String roomId) {
		roomService.findMidpoint(roomId);
		return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.updated());
	}

	@PostMapping("/{roomId}/relocation-request")
	public ResponseEntity<ApiResponse<Void>> requestRelocation(@PathVariable("roomId") String roomId) {
	...
	public ResponseEntity<ApiResponse<Void>> chooseRestaurant(
			@PathVariable("roomId") String roomId, @PathVariable Long participantId, @RequestBody RestaurantDto restaurant
	) {
	...
	public ResponseEntity<ApiResponse<Void>> resolve(@PathVariable("roomId") String roomId) {
